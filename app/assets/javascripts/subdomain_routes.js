...
Based on Rails routes of TaxonomyEndpointUi::Application
 */
...
(function() {
  ...
  createGlobalJsRoutesObject = function() {
    ...
    namespace(root, "SubdomainRoutes");
    root.SubdomainRoutes = {
admin_url: function() {
    ...
    if (typeof args[args.length - 1] == 'object') {
      var params = args.pop();
      query_params = '?' + Object.keys(params)
        .map(function (param) { return param + '=' + encodeURIComponent(params[param]); })
        .join('&');
    }

    // Remove leading and trailing slash
    var relative_path = args
      .map(function (url_part) { return url_part.toString().replace(/^\/|\/$/g, ''); })
      .join('/');

    return "localhost:3000/" + relative_path + query_params;
  },
audience_url: function() {
    var args = Array.prototype.slice.call(arguments);
    ...
    return "localhost:3001/" + relative_path + query_params;
  },
destination_url: function() {
    var args = Array.prototype.slice.call(arguments);
    ...
    return "localhost:3002/" + relative_path + query_params;
  },
company_url: function() {
    ...
    return "localhost:3003/" + relative_path + query_params;
  },
endpoint_url: function() {
    ...
    return "localhost:3004/" + relative_path + query_params;
  },
customerlink_url: function() {
    var args = Array.prototype.slice.call(arguments);
    ...
    return "localhost:3005/" + relative_path + query_params;
  },
taxonomy_endpoint_url: function() {
    var args = Array.prototype.slice.call(arguments);
    ...
    return "localhost:3006/" + relative_path + query_params;
  }}
;
    root.SubdomainRoutes.options = defaults;
    root.SubdomainRoutes.default_serializer = function(object, prefix) {
      return Utils.default_serializer(object, prefix);
    };
    return root.SubdomainRoutes;
  };
